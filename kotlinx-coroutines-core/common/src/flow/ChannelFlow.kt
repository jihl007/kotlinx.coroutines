 ...
 *
 * A channel with [default][Channel.Factory.DEFAULT_BUFFER] buffer size is created.
...
internal abstract class ChannelFlow<T>(
    ...
    public fun update(
        ...
        val newCapacity = when {
            ...
            this.capacity == DEFAULT_BUFFER -> capacity
            capacity == DEFAULT_BUFFER -> this.capacity
    ...
    private val produceCapacity: Int
        get() = if (capacity == OPTIONAL_CHANNEL) DEFAULT_BUFFER else capacity
